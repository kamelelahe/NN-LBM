function createDATBlack(numFiles,path,baseInput,baseOutput, imsize)
...
CC = im2bw(CC,0);
%image(BB)
BB=BB(1:imsize,1:imsize);
CC=CC(1:imsize,1:imsize);
...
MYBB=zeros(imsize,imsize);
MYBB(: ,3:imsize-2)=B(: ,3:imsize-2);
%figure
%'printing first slice'
fprintf(fid, '%i\n', MYBB);
%image(30*MYBB,'CDataMapping','scaled')
% colorbar
% axis equal
% drawnow
